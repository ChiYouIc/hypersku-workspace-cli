---
name: hypersku-after-sales
display_name: 1688售后管理
display_name_en: 1688 After-Sales
description_zh: 通过 hypersku-cli after-sales 子命令管理 1688 售后工单：按订单号/交易号查询售后工单列表、售后商品、退款详情与留言记录。
description_en: Manage 1688 after-sales tickets via the hypersku-cli after-sales commands: query after-sales ticket lists, refunded goods, refund details, and message records by order ID or refund ID.
description: HyperSKU 1688 售后管理。当用户提到售后工单/1688售后/退款列表/售后商品/退款详情/退款原因/卖家信息/售后留言/沟通记录时，通过 hypersku-cli after-sales 子命令查询对应数据。
version: 2.0.0
author: owen
tags:
  - hypersku
